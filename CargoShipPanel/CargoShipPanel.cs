...
{
    [Info("Cargo Ship Panel", "MJSU", "0.0.1")]
    ...
    internal class CargoShipPanel : RustPlugin
    {
        ...
        private bool _isCargoShipActive;
        ...
        private void OnServerInitialized()
        {
            ...
            timer.Every(_pluginConfig.UpdateRate, CheckCargoShip);
        }
        ...
        private void CheckCargoShip()
        {
            ...
            bool areActiveCargoShips = _activeCargoShips.Count > 0;

            if (areActiveCargoShips != _isCargoShipActive)
            {
                _isCargoShipActive = areActiveCargoShips;
        ...
        private string GetPanel()
        {
            ...
            if (image != null)
            {
                image.Color = _isCargoShipActive ? _pluginConfig.ActiveColor : _pluginConfig.InactiveColor;
            }
