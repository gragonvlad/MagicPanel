...
{
    [Info("Magic Halloween Panel", "MJSU", "1.0.1")]
    ...
    public class MagicHalloweenPanel : RustPlugin
    {
        ...
        private bool _isHalloweenActive;
        ...
        private PluginConfig AdditionalConfig(PluginConfig config)
        {
            config.Panel = new Panel
            {
                Image = new PanelImage
                {
                    ...
                    Url = config.Panel?.Image?.Url ?? "https://i.imgur.com/3fTHEiz.png",
        ...
        private void OnServerInitialized()
        {
            ...
            NextTick(() =>
            {
                _isHalloweenActive = UnityEngine.Object.FindObjectsOfType<HalloweenHunt>().Where(CanShowPanel).Any();
        ...
        private Hash<string, object> GetPanel()
        {
            ...
            if (image != null)
            {
                image.Color = _isHalloweenActive ? _pluginConfig.ActiveColor : _pluginConfig.InactiveColor;
            }
